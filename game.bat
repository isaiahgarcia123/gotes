...
if !encounter! LSS 70 goto fight
if !encounter! GEQ 70 goto treasure

:: ===== TREASURE =====
:treasure
cls
set /a loot=10 + %random% %% 30
...
:: ===== FIGHT =====
:fight
set /a enemyhp=30 + %random% %% 40
set /a enemydmg=5 + %random% %% 10
...
:attack
set /a damage=10 * !sword! + (%random% %% 5)
...
:winfight
set /a reward=15 + %random% %% 20
set /a xp_gain=20 + %random% %% 15
...
if "!shopchoice!"=="2" goto upgrade_sword
if "!shopchoice!"=="3" goto menu
...
set /a gold-=80
set /a sword+=1
echo Sword upgraded to level !sword!
pause
goto shop
